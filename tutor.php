            ...
            <div id="user-account-dropdown" class="relative">
                ...
                <div id="user-account-menu" class="absolute bottom-full left-0 right-0 mb-2 w-full bg-gray-900 rounded-lg shadow-lg border border-gray-700 hidden">
                    ...
                    <nav class="p-2">
                        ...
                        <a href="auth.php?action=logout" class="flex items-center px-3 py-2 text-red-400 hover:bg-red-500/20 hover:text-red-300 rounded-md mt-2 border-t border-gray-700 pt-3"><i class="fas fa-sign-out-alt w-6"></i> Log out</a>
                        <!-- Dark Mode Toggle -->
